...
<form action="main.php" method="POST" enctype="multipart/form-data" name="mainForm" >
	...
	<input type="hidden" name="id" value="{hocvien_type_id}">
	<input type="hidden" name="mode" value="save">
<table width="100%">
  <tr >
    <td width="22%" height="25" >Loại khách hàng:<font color="#FF0000">*</font></td>
    <td width="78%"><input name="hocvien_type_name" notnull = "1" type="text" size="70" alt="Loại khách hàng" value="{hocvien_type_name}" /></td>
  </tr>
  <tr>
    <td ></td>
...
<Script Language="JavaScript">
	...
	mainForm.hocvien_type_name.focus()
</Script>