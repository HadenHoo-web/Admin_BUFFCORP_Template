...
<div style="overflow:auto; height:80%">
  <table border="0" cellpadding="0" cellspacing="0" bordercolor="#111111" width="100%"  class="selector" style="border-collapse:collapse">
    <tr class="header">
      ...
      <td width="30" align="left" >Loại</td>
      <td width="50" align="left" >Họ và Tên</td>
      <td width="70" align="center" >Email</td>
      <td width="60" align="center" >Nội dung</td>
      <td width="50" align="center" >Ngày Comment </td>
      <td width="40" align="center" >Website</td>
    ...
    <tr class="{list.className}{list.status}">
      ...
      <td style="vertical-align:middle" class="{list.cancle}">{list.comment_type}</td>
      ...
      <td align="center" style="vertical-align:middle">{list.content}</td>
      <td align="center" style="vertical-align:middle">{list.created_date}</td>
      <td align="center" style="vertical-align:middle"><a href="{list.web}" target="_blank">{list.web}</a></td>
      <td align="center" style="vertical-align:middle">{list.rating}</td>
      <td><img border="0" src="templates/{skin}/images/check.gif" alt="Update" width="20" height="20" style="{list.checked}"></td>
      <td width="5" align="center"><a href="JavaScript:updateItem({list.comment_id})"><img border="0" src="templates/{skin}/images/editbutton.gif" alt="Update" width="20" height="20"></a></td>
      <td width="5" align="center"><a href="JavaScript:deleteItem({list.comment_id})"><img border="0" src="templates/{skin}/images/button-delete.gif" width="20" height="20" alt="Delete"></a></td>
    </tr>
    <!-- END list -->
  </table>
  </center>
