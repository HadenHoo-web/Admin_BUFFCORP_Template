...
<a href="JavaScript:returnToList()"><img border="0" src="templates/{skin}/images/back.gif" alt="Trở về danh sách phân loại đối tác" width="20" height="20"><span>Trở về danh sách</span></a>
 ...
 <div class="tabtitle">
 Thông tin keytraffic làm việc </div>
...
<table width="100%">
  <tr >
    <td width="22%" height="25" >keytraffic:<font color="#FF0000">*</font></td>
    <td width="78%"><input name="keytraffic_name" notnull = "1" type="text" size="70" alt="Loại khách hàng" value="{keytraffic_name}" /></td>
  </tr>
  <tr >
...
<Script Language="JavaScript">
	...
	mainForm.keytraffic_name.focus()
