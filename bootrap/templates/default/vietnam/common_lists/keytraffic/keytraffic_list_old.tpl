...
<div class="tabtitle">Danh sách keytraffic</div>
<div style="overflow:auto; height:80%">
  <table border="0" cellpadding="0" cellspacing="0" bordercolor="#111111" width="100%"  class="selector" style="border-collapse:collapse">
    <tr class="header">
      ...
      <td width="200" align="left" >keytraffic</td>
      <td width="150" align="left" >Pass</td>
    ...
    <tr class="{list.className}{list.status}">
      ...
      <td style="vertical-align:middle">{list.keytraffic_name}</td>
      ...
      <td width="20" align="center"><a href="?option={funname}&mode=up&id={list.keytraffic_id}&l={LANGUAGEID}"  target="_self"> <img border="0" src="templates/{skin}/images/up.png" width="16" height="16" style="{list.up}"></a> </td>
      <td width="20" align="center"><a href="?option={funname}&mode=down&id={list.keytraffic_id}&l={LANGUAGEID}" target="_self"> <img  style="{list.down}" border="0" src="templates/{skin}/images/down_blue.png" width="16" height="16"></a></td>
