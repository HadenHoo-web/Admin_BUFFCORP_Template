...
<div class="tabtitle"><form action="main.php" method="POST" enctype="multipart/form-data" name="mainForm" id="mainForm" style="margin:0px;" >
  ...
  Website <select size="1" name="website_id1" alt="Website">
        <option value=0>Chọn Website</option>
        <!-- BEGIN website_list -->
        <option value="{website_list.website_id}">{website_list.website_name}</option>
        <!-- END website_list -->
      </select>
   Show Ẩn <input type="checkbox" name="active1" value="1" {active} onChange="doReShow()" /> <input name="" type="submit" value="Search" style="height:18px; margin-top:4px;" /></form>
</div><script>mainForm.website_id1.value = '{website_id}';mainForm.member_id1.value = '{member_id}';mainForm.created_by_id1.value = '{created_by_id}';</script>
<div style="overflow:auto; height:80%">
  <table border="0" cellpadding="0" cellspacing="0" bordercolor="#111111" width="100%"  class="selector" style="border-collapse:collapse">
    <tr class="header">
      ...
      <td width="300" align="left" >Tiêu đề</td>
      <td width="120" align="left" >Website</td>
    ...
    <tr class="{list.className}{list.status}">
      ...
      <td style="vertical-align:middle"><a href="JavaScript:updateItem({list.xacnhan_id})">{list.xacnhan_name}</a></td>
      ...
      <td width="23" align="center"><a href="JavaScript:updateItem({list.xacnhan_id})"><img border="0" src="templates/{skin}/images/editbutton.gif" alt="Update" width="20" height="20"></a></td>
      <td width="35" align="center"><a href="JavaScript:deleteItem({list.xacnhan_id})"><img border="0" src="templates/{skin}/images/button-delete.gif" width="20" height="20" alt="Delete"></a></td>
    </tr>
    <!-- END list -->
  </table>
  </center>
