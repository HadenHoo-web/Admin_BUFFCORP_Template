...
<table width="100%">
  <tr >
    <td width="22%" height="25" >map:<font color="#FF0000">*</font></td>
    <td width="78%"><input name="map_name" notnull = "1" type="text" size="70" alt="Loại khách hàng" value="{map_name}" /></td>
  </tr>
  <tr >
    <td width="22%" height="25" >Url:<font color="#FF0000">*</font></td>
    <td width="78%"><input name="url" notnull = "1" type="text" size="70" alt="url" value="{url}" /></td>
  </tr>
  <tr >
    <td width="22%" height="25" >Email quản lý:</td>
    <td width="78%">
    <!-- DO ComboFromTable("email_id", "tbl_emails", "email_id", "email_name", "email_id", 0, "Chọn Email" , "0" , "1 and active = 1 order by  email_name" , "", 1) --> 
    </td>
  </tr>
  <tr >
    <td width="22%" height="25" >SĐT xác minh:</td>
    <td width="78%">
    <!-- DO ComboFromTable("tel_id", "tbl_tels", "tel_id", "tel_name", "tel_id", 0, "Chọn SĐT" , "0" , "1 and active = 1 order by  priority" , "", 1) --> 
    </td>
  </tr>
  <tr >
    <td width="22%" height="25" >Địa chỉ<font color="#FF0000">*</font></td>
    <td width="78%"><input name="address" type="text" size="70" alt="address" value="{address}" /></td>
  </tr>
  <tr >
