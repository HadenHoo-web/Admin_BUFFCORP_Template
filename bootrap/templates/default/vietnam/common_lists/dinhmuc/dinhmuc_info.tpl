...
<form action="main.php" method="POST" enctype="multipart/form-data" name="mainForm" >
	...
	<input type="hidden" name="id" value="{dinhmuc_id}">
	<input type="hidden" name="parent_id" value="{parent_id}">
	<input type="hidden" name="mode" value="save">
<table width="100%">
  <tr >
    <td width="22%" height="25" >Link:<font color="#FF0000">*</font></td>
    <td width="78%"><input name="dinhmuc_name" notnull = 1 type="text" size="70" alt="Tên định mức" value="{dinhmuc_name}" /></td>
  </tr>
  <tr >
