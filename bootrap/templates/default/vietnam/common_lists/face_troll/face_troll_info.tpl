...
<a href="JavaScript:returnToList()"><img border="0" src="templates/{skin}/images/back.gif" alt="Trở về danh sách phân loại đối tác" width="20" height="20"><span>Trở về danh sách</span></a>
 ...
 <div class="tabtitle">
 Thông tin Nick face đối thủ cướp khách </div>
...
<form action="main.php" method="POST" enctype="multipart/form-data" name="mainForm" >
	...
	<input type="hidden" name="id" value="{face_troll_id}">
	<input type="hidden" name="mode" value="save">
<table width="100%">
  <tr >
    <td width="22%" height="25" >Face Troll:<font color="#FF0000">*</font></td>
    <td width="78%"><input name="face_troll_name" notnull = "1" type="text" size="70" alt="Loại khách hàng" value="{face_troll_name}" /></td>
  </tr>
  <tr >
...
<Script Language="JavaScript">
	...
	mainForm.face_troll_name.focus()
