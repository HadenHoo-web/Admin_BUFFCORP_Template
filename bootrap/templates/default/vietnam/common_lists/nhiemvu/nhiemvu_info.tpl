...
<a href="JavaScript:returnToList()"><img border="0" src="templates/{skin}/images/back.gif" alt="Về danh sách" width="20" height="20"><span>Về danh sách</span></a>
 ...
 <div class="tabtitle">
 Thông tin Định mức kho : &quot;{parent_name}&quot; </div>
...
<form action="main.php" method="POST" enctype="multipart/form-data" name="mainForm" >
	...
	<input type="hidden" name="id" value="{nhiemvu_id}">
	<input type="hidden" name="parent_id" value="{parent_id}">
	<input type="hidden" name="mode" value="save">
<table width="100%">
  <tr >
    <td width="22%" height="25" >Nhiệm vụ:<font color="#FF0000">*</font></td>
    <td width="78%"><input name="nhiemvu_name" notnull = 1 type="text" size="70" alt="Tên định mức" value="{nhiemvu_name}" /></td>
  </tr>
  <tr >
    <td width="22%" height="25" >Số lượng:</td>
    <td width="78%"><input name="soluong" notnull = 1 type="text" size="70" alt="Số lượng" value="{soluong}" /></td>
  </tr>
  <tr>
    <td ></td>
