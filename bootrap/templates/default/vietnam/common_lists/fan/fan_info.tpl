...
<form action="main.php" method="POST" enctype="multipart/form-data" name="mainForm" >
	...
	<input type="hidden" name="id" value="{fan_id}">
	<input type="hidden" name="mode" value="save">
<table width="100%">
  <tr >
    <td width="22%" height="25" >fan:<font color="#FF0000">*</font></td>
    <td width="78%"><input name="fan_name" notnull = "1" type="text" size="70" alt="Loại khách hàng" value="{fan_name}" /></td>
  </tr>
  <tr >
    <td width="22%" height="25" >Pass:<font color="#FF0000">*</font></td>
    <td width="78%"><input name="pass" notnull = "1" type="text" size="70" alt="Pass" value="{pass}" /> Lượt like <input name="like_num" notnull = "1" type="text" size="5" alt="Like number" value="{like_num}" /></td>
  </tr>
  <tr >
