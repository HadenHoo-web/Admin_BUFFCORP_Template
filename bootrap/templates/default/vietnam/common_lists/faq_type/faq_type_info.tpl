...
<form action="main.php" method="POST" enctype="multipart/form-data" name="mainForm" >
	...
	<input type="hidden" name="id" value="{faq_type_id}">
	<input type="hidden" name="parent_id" value="{parent_id}">
	<input type="hidden" name="mode" value="save">
<table width="100%">
  <tr >
    <td width="22%" height="25" >Tên nhóm:<font color="#FF0000">*</font></td>
    <td width="78%"><input name="faq_type_name" notnull = 1 type="text" size="70" alt="Tên nhóm" value="{faq_type_name}" /></td>
  </tr>
