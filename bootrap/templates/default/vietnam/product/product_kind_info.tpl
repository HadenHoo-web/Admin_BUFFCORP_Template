...
<form action="main.php" method="POST" enctype="multipart/form-data" name="mainForm" >
	...
	<input type="hidden" name="id" value="{product_kind_id}">
	<input type="hidden" name="mode" value="save">
<table width="100%">
  <tr >
    <td width="22%" height="25" >Loại sản phẩm:<font color="#FF0000">*</font></td>
    <td width="78%"><input name="product_kind_name" notnull = 1 type="text" size="70" alt="Thương hiệu" value="{product_kind_name}" /> <input name="view" type="text" size="5" alt="Xem" value="{view}" /></td>
  </tr>
  <tr>
    <td width="20%">
    Cập nhật hình:</td>
...
<Script Language="JavaScript">
	...
	mainForm.product_kind_name.focus()
</Script>