...
<table width="100%">
  <tr >
    <td width="22%" height="25" >Loại màu sắc:<font color="#FF0000">*</font></td>
    <td width="78%"><input name="color_name" notnull = 1 type="text" size="70" alt="Loại màu sắc" value="{color_name}" /></td>
  </tr>
  <tr>
    <td width="20%">
    Cập nhật hình:</td>
