...
<form action="main.php" method="POST" enctype="multipart/form-data" name="mainForm" >
	...
	<input type="hidden" name="id" value="{loaikho_id}">
	<input type="hidden" name="mode" value="save">
<table width="100%">
  <tr >
    <td width="22%" height="25" >Loại Kho:<font color="#FF0000">*</font></td>
    <td width="78%"><input name="loaikho_name" notnull = 1 type="text" size="70" alt="Loại Da" value="{loaikho_name}" /></td>
  </tr>
  <tr>
    <td width="20%">
    Cập nhật hình:</td>
