...
<tr>
	<td width="20%" style="padding-left: 10" >Current password:</td>
      <td width="100%"  ><input name="old_password" size="46" notnull=1 alt="current password" type="password"></td>
</tr>
  <tr>
...
mainForm.old_password.focus()

function checkform()
{	
	if  (mainForm.old_password.value == '')
	{	alert("Current password can not be empty. Please try again!")
		return false
	}
	if  (mainForm.new_password.value == '')
	{	alert("New password can not be empty. Please try again!")
		return false
	}
