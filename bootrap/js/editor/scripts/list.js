...
function RUN()
	...
	sHTML+= "</td><td style='padding-left:3;padding-right:3;'>" +
			"	<input type=button class=inpBtn value=' >> ' onclick='"+this.oName+".add()'><div style='padding:2'></div>" +
			"	<input type=button class=inpBtn value=' << ' onclick='"+this.oName+".remove()'>" +
			"</td><td valign=top>" +
