...
{		
	...
	$default_product_type_id = (strtolower($_SESSION['membername'])=="administrator" || $_SESSION['loginname']=="kieu" || $_SESSION["login_id"] == 2) ? '0' : '29';
	$product_type_id	 = mosGetParam( $_REQUEST, 'product_type_id1', $default_product_type_id );
